...
The HTTP server functionality has been moved to a standalone package: **[@finos/calm-server](../calm-server/README.md)**

This provides a dedicated REST API for validating CALM architectures and patterns without requiring the full CLI.
...
curl -H "Content-Type: application/json" -X POST http://127.0.0.1:3000/calm/validate --data @architecture.json
```

For detailed information, see the [@finos/calm-server documentation](../calm-server/README.md).
